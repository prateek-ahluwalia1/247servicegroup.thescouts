					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-0 fs-2">Charged Rates List</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
							<!--begin::Wrapper-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
								...
								<div class="card-header border-0 pt-6" style="display: inline-block !important;">
									...
									<div class="card-title">
										...
										<div class="d-flex align-items-center position-relative my-1">
											...
											<!--end::Svg Icon-->
											<input type="text" id="search"  class="form-control form-control-solid w-250px ps-14" placeholder="Search Charge Rate" />
										</div>
										<!--end::Search-->
									</div>
									<!--begin::Card title-->
						...
						<!-- 					<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users">
										...
										Export</button>
											...
											<button type="button" id="#charged_rate-modal" class="btn btn-primary" onclick="add_modal()">
											...
											<!--end::Svg Icon--><span >Add charge rate</span></button>
											<!--end::Add user-->
										</div>
										<!--end::Toolbar-->
										<!--begin::Group actions-->
									...
									<!-- active edit charge rate model -->
									<div class="modal fade" id="charged_rate-modal" tabindex="-1" aria-hidden="true">
										<!--begin::Modal dialog-->
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												...
												<div class="modal-header modal_custom_head" id="kt_modal_add_user_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder" id="form_head">Add charge rate</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
												...
												<!--end::Modal header-->
												<!--begin::Modal body-->
												<div class="modal_card_custom modal_custom_body modal-body scroll-y mx-5 mx-xl-15 my-7">
													<!--begin::Form-->
													<form id="charged_rates-form" class="form" action="{{url('create_charged_rate')}}" method="POST" enctype="multipart/form-data"> @csrf
														<!--begin::Scroll-->
														<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
															...
															<!--begin::Input group-->
																	...
																	<!-- <div class="fv-row mb-7">
																		...
																		<input type="date" id="effective_date" name="effective_date" class="form-control form-control-solid mb-3 mb-lg-0 form-control-md datepicker flatpickr-input" placeholder="Effective Date" value="" required />
																	</div> -->
																	<!--end::Input group-->
															<!--begin::Input group-->
															...
															<div class="row rates-section" style="">
																...
																<div class="fv-row mb-10">
																				...
																				<select class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" id="position" name="position" onchange="load_guard_charged_rates(0, 'job_level', 'charged_rates_state', 'position')">
															...
															<option value="casual" >Casual</option>
																...
																<div class="col-md-4 form-group">
																	<div class="fv-row mb-10">
																		...
																		<select class="form-select form-select-lg form-select-solid" data-placeholder="Select..." name="job_level" id="job_level" onchange="load_guard_charged_rates(0, 'job_level', 'charged_rates_state', 'position')">
																...
																<div class="col-md-4 form-group">
																	<div class="fv-row mb-10">
																		...
																		<select class="form-select  form-select-solid" data-placeholder="Select..." name="charged_rates_state" id="charged_rates_state" onchange="load_guard_charged_rates(0, 'job_level', 'charged_rates_state', 'position')">
															...
															<div class="row">
																	...
																	<div class="rTable">
																		<div class="rTableBody">
																			...
																			@foreach($divisions as $key => $division)
																					<div class="rTableRow">
																						<div class="rTableCell">
																							<select class="form-control" name="division_normal_id_{{$key}}">
																								@foreach($divisions as $d)
																								<option value="{{$d->id}}" disabled="" {{($division->id == $d->id ? 'selected=""' : '') }}>{{$d->name}}</option>
																								@endforeach
																							</select>
																						</div>
																						<div class="rTableCell text-center">Rate</div>
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="division_normal_rate_{{$key}}" type="number" step="any">
																						</div>
																					</div>
																					@endforeach
																		</div>
																...
																<input type="hidden" name="division_count" value="{{count($divisions)}}">
																<!-- <div class="col-md-12">
																			<div class="fv-row mb-10">
          						<label class="required fs-6 fw-bold form-label mb-2">Division Rate:</label>
          						<input type="number" id="normal_rate" name="normal_rate" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rate" value="" step="any">
          					</div>
																		</div> -->
															</div>
															<hr>
															<div class="row rates-section">
																<div class="col-md-6">
																	<h4 class="text-center">EBA-Awards1</h4></div>
															</div>
															<div class="row rates-section">
																<div class="col-md-12">
																	<div class="rTable">
																		<div class="rTableBody">
																			...
																			@foreach($divisions as $key => $division)
																					<div class="rTableRow">
																						<div class="rTableCell">
																							<select class="form-control" name="division_eba_id_{{$key}}">
																								@foreach($divisions as $d)
																								<option value="{{$d->id}}" disabled="" {{($division->id == $d->id ? 'selected=""' : '') }}>{{$d->name}}</option>
																								@endforeach
																							</select>
																						...
																						<div class="rTableCell text-center">Rate</div>
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="division_eba_rate_{{$key}}" type="number" step="any">
																						</div>
																					</div>
																					@endforeach
																	...
																	<input type="hidden" name="update_charge_id" id="update_charge_id">
																	<br>
																	<br> </div>
																	<!-- <div class="col-md-12">
																			<div class="fv-row mb-10">
          						<label class="required fs-6 fw-bold form-label mb-2">Division Rate:</label>
          						<input type="number" id="eba_rate" name="eba_rate" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rate" value="" step="any">
          					</div>
																		</div> -->
															</div>
															</br>
															<button type="button" class="btn btn-primary" data-kt-users-modal-action="" onclick="updateChargeRate()"> <span class="indicator-label" >Save</span>
															</button>
															</br>
															</br>
														</div>
									...
									<!--end::Modal - Add task-->
														...
														<div class="modal_card_custom modal_custom_body modal-body scroll-y mx-5 mx-xl-15 my-7">
															...
															<option value="casual" >Casual</option>
																		...
																		<div class="col-md-4 form-group">
																			<div class="fv-row mb-10">
																				<label for="recipient-name" class="col-form-label">Job Level</label>
																				<select class="form-select form-select-lg form-select-solid" data-placeholder="Select..." name="job_level" id="job_level" onchange="load_guard_charged_rates()">
																					<option value="1">Level 1</option>
																					<option value="2">Level 2</option>
																					<option value="3">Level 3</option>
																					<option value="4">Level 4</option>
																		...
																		<div class="col-md-6 form-group">
																			<div class="fv-row mb-10">
																				<label for="recipient-name" class="col-form-label">State</label>
																				<select class="form-select  form-select-solid" data-placeholder="Select..." name="charged_rates_state" id="charged_rates_state" onchange="load_guard_charged_rates()">
																					<option value="Victoria">Victoria</option>
																					<option value="New South Wales">NSW</option>
																					<option value="Queensland">Queensland</option>
																					<option value="Tasmania">Tasmania</option>
																		...
																		<div class="col-md-12">
																			<div class="rTable">
																				<div class="rTableBody">
																					...
																					<div class="rTableRow">
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="eba_metro_weekend" type="number" step="any">
																						</div>
																						<div class="rTableCell text-center">Sat (00:01 till 23:59)</div>
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="eba_regional_weekend" type="number" step="any">
																						</div>
																					</div>
																					<div class="rTableRow">
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="eba_metro_weekend_sun" type="number" step="any">
																						</div>
																						<div class="rTableCell text-center">Sun (00:01 till 23:59)</div>
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="eba_regional_weekend_sun" type="number" step="any">
																						</div>
																					</div>
																					<div class="rTableRow">
																						<div class="rTableCell">
											...
											<!--end::Modal - Add task-->
											{{-- add new --}}
											<!-- active add charge rate model -->
											<!--begin::Modal - Add task-->
											<div class="modal fade" id="charged_rate-modal_add" tabindex="-1" aria-hidden="true">
												<!--begin::Modal dialog-->
												<div class="modal-dialog modal-dialog-centered mw-650px">
													<!--begin::Modal content-->
													<div class="modal-content">
														...
														<div class="modal_card_custom  modal_custom_body modal-body scroll-y mx-5 mx-xl-15 my-7">
															<!--begin::Form-->
															<form id="charged_rates-form_add" class="form" action="{{url('create_charged_rate')}}" method="POST" enctype="multipart/form-data"> @csrf
																<!--begin::Scroll-->
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	<!--begin::Input group-->
																	<div class="fv-row mb-7">
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<select class="form-select form-select-lg form-select-solid" data-placeholder="Select..." name="customer_id" id="charge_rate_customer" required="">
																			<option value="">Select Customer</option>
																			@foreach($customers as $customer)
																			<option value="{{$customer->id}}">{{$customer->name}}</option>
																			@endforeach
															...
															<option value="casual" >Casual</option>
																	...
																	<div class="row">
																			...
																			<div class="rTable">
																				<div class="rTableBody">
																					...
																					<div class="rTableRow" style="display: none;">
																						...
																						<div class="rTableCell text-center">Friday</div>
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="flat_regional_friday" type="number" step="any">
																						</div>
																					</div>
																					...
																					<div class="rTableRow">
																						<div class="rTableCell">
																							<input value="0" class="form-control form-control-md" name="flat_metro_sunday" id="flat_metro_sunday" onchange="copyValue('flat_metro_sunday', 'flat_metro_sunday_night')" type="number" step="any">
																						</div>
																		...
																		<!-- <div class="col-md-12">
																			<div class="fv-row mb-10">
          						<label class="required fs-6 fw-bold form-label mb-2">Division Rate:</label>
          						<input type="number" id="rate" name="normal_rate" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rate" value="" step="any">
          					</div>
																		</div> -->
																	</div>
																	<hr>
          						...
          						<input type="number" id="rate" name="eba_rate" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rate" value="" step="any">
          					</div>
																		</div> -->
																		
																	</br>
																	<button type="button" class="btn btn-primary" data-kt-users-modal-action="" onclick="saveChargeRate()"> <span class="indicator-label">Save</span>
																	</button>
																	<!-- </br> -->
																	<!-- </br> -->
																</div>
                                        ...
                                        <ul
                                            class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6 nav-stretch  nav-fill nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                                                <li class="nav-item">
                                                    ...
                                                    <a class="nav-link text-active-primary me-6 {{$rate_type == 'Active' ? 'active' : ''}}" href="{{url('charged_rates')}}">Active</a>

                                                </li>
                                                <li class="nav-item">

                                                    <a class="nav-link  text-active-primary me-6 {{$rate_type == 'Archive' ? 'active' : ''}}" 
                                                        href="{{url('charged_rates?type=archive')}}">Archive</a>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px">charged rate</th>
											...
											<tr>
												...
												<td class="d-flex align-items-center">
													...
													<div class="d-flex flex-column">
														<a  class="text-gray-800 text-hover-primary mb-1" type="button"  data-bs-toggle="modal" data-bs-target="" onclick="get_charged_rates_detail( {{ $charged_rate->id }})">{{$charged_rate->title}}</a>
													</div>
													<!--begin::User details-->
												</td>
												<!--end::User=-->
												...
												<td>
													@foreach($charged_rate->groupData as  $index => $data)
													{{$data->level}}
													@if($index < count($charged_rate->groupData)-1)
													,
													@endif
													@endforeach
												</td>
												...
												<div class="form-check form-check-solid form-switch fv-row">
														...
														<input class="form-check-input w-45px h-30px" type="checkbox" id="active_inactive_status" name="active_inactive_status" onchange="changeStatus({{$charged_rate->id}},this)" {{$charged_rate->archive == 1 ? 'checked' : ''}}>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<a type="button" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="" onclick="get_charged_rates( {{ $charged_rate->id }})">Edit</a>
														</div> -->
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a type="button" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="" onclick="delete_charged_rate( {{ $charged_rate->id }})" >Delete</a>
														</div>
														<!--end::Menu item-->
													</div>
													<!--end::Menu-->
...
function get_charged_rates(id){
	$('#update_charge_id').val(id)
	$("#charged_rates_edit-form :input").prop("disabled", false);
    $("#charged_rates-form :input").prop("disabled", false);
	  $("#charged_rates_edit-form :input").prop("disabled", false);
        		    $('#form_submit-button').show();

					load_guard_charged_rates(id, 'job_level', 'charged_rates_state', 'position');
               	           $('#charged_rate-modal').modal('show');
						document.getElementById("form_button").innerHTML = "Update!";
					$('#charged_rates-form').attr('id','charged_rates_edit-form');
					$('#charged_rates_edit-form').attr('method', "POST");


				    $('#charged_rates_edit-form').attr('action', `{{url('update_charged_rates')}}/${id}`);
				  document.getElementById("form_head").innerHTML = "Edit charged rate";
               }
function openModal() {
...
function get_charged_rates_detail(id){

					load_guard_charged_rates(id);
            $('#charged_rate-modal').modal('show');
				  document.getElementById("form_head").innerHTML = " Charged Rate Details";
                // document.getElementsByClassName("form-control-md").disabled = true; 
                $("#charged_rates_edit-form :input").prop("disabled", true);
                //$("#charged_rates-form :input").prop("disabled", true);
...
function openModal() {
	   ...
	   function add_modal(){ 
$('.form').trigger("reset");
$('#charged_rate-modal_add').modal('show');


}

function delete_charged_rate(id){
...
Swal.fire({
		...
		t.value ? (
			$.ajax({type: "POST",url: `{{url('delete_charged_rate')}}/${id}`, data:{_token:'<?php echo csrf_token();?>'},success: function(result){
				Swal.fire({
		...
		window.location.href = "{{ url('/charged_rates')}}";
  ...
  $("#export_user_form").on('submit', function(e){
    ...
    function saveChargeRate()
    {
    	if ($('#charge_rate_customer').val() == '') {
Swal.fire({
...
return;
    	...
    	var data = $('#charged_rates-form_add').serialize();
    	$.ajax({type: "POST",url: '{{url('create_charged_rate')}}',data : data,success: function(result){if(result.success){
											     	Swal.fire({
											                        text: "Charge rate created successfully! ",
											                        icon: "success",
											                        buttonsStyling: !1,
    ...
    $("#charged_rates-form_add").on('submit', function(e){
					     e.preventDefault();
					     console.log(this.id)
					     var data = $('#'+this.id).serialize();
					     $.ajax({type: "POST",url: this.action,data : data,success: function(result){if(result.success){
...
{
	var id = $('#update_charge_id').val();
var data = $('#charged_rates_edit-form').serialize();
					     $.ajax({type: "POST",url: `{{url('update_charged_rates')}}/${id}`,data : data,success: function(result){if(result.success){
											     	Swal.fire({
											                        text: "Charge Rate Updated Successfully! ",
											                        icon: "success",
											                        buttonsStyling: !1,
											                        confirmButtonText: "OK",
											                        customClass: {
    ...
    $("#charged_rates_edit-form").on('submit', function(e){
					     e.preventDefault();
					     console.log(this.id)
					     var data = $('#'+this.id).serialize();
					     $.ajax({type: "POST",url: this.action,data : data,success: function(result){if(result.success){
											     	Swal.fire({
											                        text: "charged rate Updated Successfully! ",
											                        icon: "success",
											                        buttonsStyling: !1,
											                        confirmButtonText: "OK",
											                        customClass: {
    				...
    				function load_guard_charged_rates(id, level_id, state_id = null, position = null){
								...
								$.ajax({
						        type: "POST",
						        url: "{{url('/get_charged_rates/')}}" + '/' + id,
						        data : {id:id , _token : '{{ csrf_token()}}', level:level, state:state, name:name, position:position},
						        success: function(result){
						        if (result.success) {
              						
						        	$('#update_charge_id').val(result.charged_rates.id)
						        	// $('#effective_date').val(result.charged_rates.effective_date)
						        	$('#customer_id').val(result.charged_rates.customer_id)
						        	$('#position').val(result.charged_rates.position)

						        	$('input[name="flat_metro_week_day"]').val(result.charged_rates.flat_metro_flat_metro_week_day)
						        	$('input[name="flat_metro_weekend"]').val(result.charged_rates.flat_metro_weekend)
						        	$('input[name="flat_metro_public_holiday"]').val(result.charged_rates.flat_metro_public_holiday)
						        	$('input[name="flat_regional_week_day"]').val(result.charged_rates.flat_regional_week_day)
						        	$('input[name="flat_regional_weekend"]').val(result.charged_rates.flat_regional_weekend)
						        	$('input[name="flat_regional_public_holiday"]').val(result.charged_rates.flat_regional_public_holiday);
						        	$('input[name="eba_metro_weekday_day"]').val(result.charged_rates.eba_metro_weekday_day);
						        	$('input[name="eba_metro_weekday_afternoon"]').val(result.charged_rates.eba_metro_weekday_afternoon);
						        	$('input[name="eba_metro_weekday_night"]').val(result.charged_rates.eba_metro_weekday_night);
						        	$('input[name="eba_metro_weekend"]').val(result.charged_rates.eba_metro_weekend);
						        	$('input[name="eba_metro_public_holiday"]').val(result.charged_rates.eba_metro_public_holiday);
						        	$('input[name="eba_regional_weekday_day"]').val(result.charged_rates.eba_regional_weekday_day);
						        	$('input[name="eba_regional_weekday_afternoon"]').val(result.charged_rates.eba_regional_weekday_afternoon);
						        	$('input[name="eba_regional_weekday_night"]').val(result.charged_rates.eba_regional_weekday_night);
						        	$('input[name="eba_regional_weekend"]').val(result.charged_rates.eba_regional_weekend);
						        	$('input[name="eba_regional_public_holiday"]').val(result.charged_rates.eba_regional_public_holiday);
						        	$('input[name="title"]').val(result.charged_rates.title);
									
									$('input[name="eba_regional_weekend_sun"]').val(result.charged_rates.eba_regional_weekend_sun);
						        	$('input[name="eba_metro_weekend_sun"]').val(result.charged_rates.eba_metro_weekend_sun);
									$('#job_level').val(result.charged_rates.level);
									$('#charged_rates_state').val(result.charged_rates.state);

						        	$('input[name="flat_metro_week_day_day"]').val(result.charged_rates.flat_metro_week_day_day);
						        	$('input[name="flat_regional_week_day_day"]').val(result.charged_rates.flat_regional_week_day_day);
						        	$('input[name="flat_metro_week_day_night"]').val(result.charged_rates.flat_metro_week_day_night);
						        	$('input[name="flat_regional_week_day_night"]').val(result.charged_rates.flat_regional_week_day_night);
						        	$('input[name="flat_metro_friday"]').val(result.charged_rates.flat_metro_friday);
						        	$('input[name="flat_regional_friday"]').val(result.charged_rates.flat_regional_friday);
						        	$('input[name="flat_metro_saturday"]').val(result.charged_rates.flat_metro_saturday);
						        	$('input[name="flat_regional_saturday"]').val(result.charged_rates.flat_regional_saturday);
						        	$('input[name="flat_metro_sunday"]').val(result.charged_rates.flat_metro_sunday);
						        	$('input[name="flat_regional_sunday"]').val(result.charged_rates.flat_regional_sunday);
						        	$('input[name="flat_regional_sunday_night"]').val(result.charged_rates.flat_regional_sunday_night);
						        	$('input[name="flat_metro_sunday_night"]').val(result.charged_rates.flat_metro_sunday_night);
						        	$('input[name="flat_metro_saturday_night"]').val(result.charged_rates.flat_metro_saturday_night);
						        	$('input[name="flat_regional_saturday_night"]').val(result.charged_rates.flat_regional_saturday_night);
						        	$('input[name="flat_metro_public_holiday_night"]').val(result.charged_rates.flat_metro_public_holiday_night);
						        	$('input[name="flat_regional_public_holiday_night"]').val(result.charged_rates.flat_regional_public_holiday_night);

						        	$('input[name="eba_metro_saturday_day"]').val(result.charged_rates.eba_metro_saturday_day);
						        	$('input[name="eba_regional_saturday_day"]').val(result.charged_rates.eba_regional_saturday_day);
						        	$('input[name="eba_metro_saturday_night"]').val(result.charged_rates.eba_metro_saturday_night);
						        	$('input[name="eba_regional_saturday_night"]').val(result.charged_rates.eba_regional_saturday_night);
						        	$('input[name="eba_metro_sunday_day"]').val(result.charged_rates.eba_metro_sunday_day);
						        	$('input[name="eba_regional_sunday_day"]').val(result.charged_rates.eba_regional_sunday_day);
						        	$('input[name="eba_metro_sunday_night"]').val(result.charged_rates.eba_metro_sunday_night);
						        	$('input[name="eba_regional_sunday_night"]').val(result.charged_rates.eba_regional_sunday_night);
						        	$('input[name="eba_metro_public_holiday_night"]').val(result.charged_rates.eba_metro_public_holiday_night);
						        	$('input[name="eba_regional_public_holiday_night"]').val(result.charged_rates.eba_regional_public_holiday_night);
						        	// $('input[name="normal_rate"]').val(result.charged_rates.normal_rate);
						        	// $('input[name="eba_rate"]').val(result.charged_rates.eba_rate);
						        	$.each(result.charged_rates.eba_rate, function(indx, val){
						        		$('select[name="division_eba_id_'+indx+'"]').val(val.id);
						        		$('input[name="division_eba_rate_'+indx+'"]').val(val.rate);
						        	});
						        	$.each(result.charged_rates.normal_rate, function(indx, val){
						        		$('select[name="division_normal_id_'+indx+'"]').val(val.id);
						        		$('input[name="division_normal_rate_'+indx+'"]').val(val.rate);
						        	});
						        	...
						        	// $('input[name="normal_rate"]').val(0);
						        	// $('input[name="eba_rate"]').val(0);
						        }
...
function changeStatus(id, e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('changeStatusChargeRate') }}",
                data: {
                    id: id,
                    check: check,
                ...
                success: function(result) {
                    ...
                    window.location.href = "{{ url('/charged_rates') }}?type={{$rate_type}}";
