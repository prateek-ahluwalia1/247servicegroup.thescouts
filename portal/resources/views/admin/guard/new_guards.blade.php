						...
						<div >
								...
								<thead>
									...
									<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
										...
										<th class="min-w-125px">New {{config('custom.guard')}}</th>
				...
				$percent += 7;
										...
										<td class="text-end">
											<div class="d-flex justify-content-end flex-shrink-0">
												<a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" type="button" onclick="resend_guard_email({{$guard->id}})"> <img style="margin-left:5px" src="https://img.icons8.com/fluency/20/000000/mail.png"/></a>
