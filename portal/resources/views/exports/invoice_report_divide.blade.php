<table>
 <thead>
  <tr>
   ...
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 50px;">Saturday Day Hours</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 50px;">Saturday Day Rates</th>
   ...
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 50px;">Sunday Day Hours</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 50px;">Sunday Day Rates</th>
...
<tbody>
 ...
 $val['site_name'] = $val['site_name'] != '' ? $val['site_name'] : 'N/A';
  ...
  <td style="text-align:center; background-color: #808080; border:1px solid #000000; font-weight: bold;"></td>
  <td style="text-align:center; background-color: #DCE6F1; border:1px solid #000000; font-weight: bold;">{{number_format($total_saturday_day_hours, 2)}}</td>
  <td style="text-align:center; background-color: #808080; border:1px solid #000000; font-weight: bold;"></td>
  ...
  <td style="text-align:center; background-color: #808080; border:1px solid #000000; font-weight: bold;"></td>
  <td style="text-align:center; background-color: #DCE6F1; border:1px solid #000000; font-weight: bold;">{{number_format($total_sunday_day_hours, 2)}}</td>
  <td style="text-align:center; background-color: #808080; border:1px solid #000000; font-weight: bold;"></td>
...
<?php 
  ...
  <td style="text-align:center; background-color: #808080; border:1px solid #000000;"></td>
  <td style="text-align:center; background-color: #DCE6F1; border:1px solid #000000;">{{number_format($total_saturday_day_hours, 2)}}</td>
  <td style="text-align:center; background-color: #808080; border:1px solid #000000;"></td>
  <td style="text-align:center; background-color: #EBF1DE; border:1px solid #000000;">{{number_format($total_saturday_night_hours, 2)}}</td>
  <td style="text-align:center; background-color: #808080; border:1px solid #000000;"></td>
  <td style="text-align:center; background-color: #DCE6F1; border:1px solid #000000;">{{number_format($total_sunday_day_hours, 2)}}</td>
  <td style="text-align:center; background-color: #808080; border:1px solid #000000;"></td>
...
@endforeach
 <tr>
  ...
  <td style="text-align:right;border:1px solid #000000;"></td>
  <td style="text-align:right; background-color: #8DB4E2; border:1px solid #000000;">{{number_format($sadh, 2)}}</td>
  <td style="text-align:right;border:1px solid #000000;"></td>
  <td style="text-align:right; background-color: #D8E4BC; border:1px solid #000000;">{{number_format($sanh, 2)}}</td>
  <td style="text-align:right;border:1px solid #000000;"></td>
  <td style="text-align:right; background-color: #8DB4E2; border:1px solid #000000;">{{number_format($sudh, 2)}}</td>
  <td style="text-align:right;border:1px solid #000000;"></td>
