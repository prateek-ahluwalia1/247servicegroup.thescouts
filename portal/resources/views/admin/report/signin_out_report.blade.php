	...
	<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
		...
		<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
			...
			<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
				<!--begin::Heading-->
				<h1 class="text-dark fw-bolder my-0 fs-2">Signin-Out Report</h1>
				<!--end::Heading-->
			</div>
			<!--end::Page title=-->
			<!--begin::Wrapper-->
                                    			...
                                    			<div class="row">
                                    				<div class="col-6">
                                    					<div class="position-relative w-md-400px me-md-2 mr-2">
                                    							...
                                    							<!--begin::Select-->
                                    							<select class="form-select form-select-solid" data-control="select2" data-placeholder="" data-hide-search="true" id="customer-state" name="customer-state" tabindex="0" aria-hidden="false">
                                    					...
                                    					<div class="col-6">
                                    						<div class="position-relative w-md-400px me-md-2 mr-2">
                                    							<label class=" fs-6 form-label fw-bolder text-dark">Customer</label>
                                    				...
                                    				<div class="col-6">
                                    					...
                                    					<div class="position-relative w-md-400px me-md-2 mr-2">
                                    						<div class="col-lg-6 " id="guard-list-data">
                                    				...
                                    				<div class="col-lg-12 text-center">
                                    					...
                                    					<!--begin:Action-->
                                    					<div class="d-flex align-items-center">
                                    						<button type="submit" onclick="generateReport()" class="btn btn-primary me-5">Export</button>
                                    					</div>
                                    					<!--end:Action-->
                                    				</div>
                                    			</div>
    ...
    // customerId=customerId.value;
                ...
                // if (check == false) {
					...
					// MultiselectDropdown(window.MultiselectDropdownOptions);
                                					...
                                					task_report_onchange($('#customer_name').val());
                                				}
                                			});
                                		...
                                		function task_report_onchange(customerId){
                                			$.ajax({type: "GET",url:' {{url('job_tracker/get_customers_guards_list_filter/')}}',data:{customer_id:customerId,state : $('#customer-state').val(), _token :'<?php echo csrf_token() ?>'},success: function(result){
                                				...
                                				{
                                					siteData2+= '<option value="' + data.guard_id + '">' + data.guard_name +'</option>';
                                				});
...
function generateReport()
{
    ...
    window.open('{{url('')}}/export_signin_out_report?search='+$('#kt_daterangepicker_1').val()+'&sites='+$('#specific_customer_sites').val()+'&customer_name='+$('#customer_name').val()+'&guard_name='+$('#guard_name').val(), '_blank');
          				// $(".buttons-excel").click()
