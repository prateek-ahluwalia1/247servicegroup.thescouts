...
@section('content')
@if(session()->get('config_arr_job_roster'))
@foreach(session()->get('config_arr_job_roster') as $item)
				...
				@if(session()->get('userType')=='admin' || session()->get('userType')=='customer')
							...
							@if($is_super_admin == 1 || (isset($permissions['roster_action']) && $permissions['roster_action'] == true))
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
															...
															<div class="menu-item px-3 my-1 hide action-week">
																<a id="copy_shifts" href="#" class="menu-link px-3" data-toggle="modal" data-target="#copyShifts" data-backdrop="static" data-keyboard="false">
																	<!-- Copy to this week -->
																	Copy Shifts
																</a>
															</div>
													...
													<!--end::Menu-->
													@if($item->publish == '1')
													<button  type="button" class="btn btn-action ml-2" id="publish-calendar-btn" data-backdrop="static" data-keyboard="false" style="margin-left: 5px;" disabled="">Old Publish <span style="display: none;" id="unpublish-count"></span></button>
																	<button  type="button" class="btn btn-action ml-2"  id="addPublishBtn" data-toggle="modal" data-target="#addPublish" data-backdrop="static" data-keyboard="false" style="margin-left: 5px;">Publish <span style="display: none;" id="unpublish-count"></span></button>
																	@endif

										@if($is_super_admin == 1 || (isset($permissions['add_site']) && $permissions['add_site'] == true))
										@if($item->add_site == '1')
...
@if($is_super_admin == 1 || (isset($permissions['roster_report']) && $permissions['roster_report'] == true))
										<div style="display: inline-block;">
											@if($item->report == '1')
										<button href="#" class="btn  btn-action" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">Report
...
@endif
							...
							<div class="container">
								<div class="row">
									<div class="col-2">
										<div style="background-color: {{(!empty($p_colors) && isset($p_colors['pending_shifts']) ? $p_colors['pending_shifts'] : 'rgba(132, 179, 205, 0.25)')}};  width: 20px; height: 20px;"></div>
										<span>Pending Shifts</span>
									</div>
									<div class="col-2">
										<div style="background-color: {{(!empty($p_colors) && isset($p_colors['rejected_shifts']) ? $p_colors['rejected_shifts'] : '#FFFF00')}};  width: 20px; height: 20px;"></div>
										<span>Rejected Shifts</span>
									</div>
									<div class="col-2">
										<div style="background-color: {{(!empty($p_colors) && isset($p_colors['publish_shifts']) ? $p_colors['publish_shifts'] : 'rgba(132, 179, 205, 0.25)')}};  width: 20px; height: 20px;"></div>
										<span>Publish Shifts</span>
									</div>
									<div class="col-2">
										<div style="background-color: {{(!empty($p_colors) && isset($p_colors['unpublish_shifts']) ? $p_colors['unpublish_shifts'] : '#fff')}};  width: 20px; height: 20px;"></div>
										<span>Unpublish Shifts</span>
									</div>
									<div class="col-2">
										<div style="background-color: {{(!empty($p_colors) && isset($p_colors['mock_shifts']) ? $p_colors['mock_shifts'] : '#C4D79B')}};  width: 20px; height: 20px;"></div>
										<span>Mock Shifts</span>
									</div>
									<div class="col-2">
										<div style="background-color: {{(!empty($p_colors) && isset($p_colors['missed_shifts']) ? $p_colors['missed_shifts'] : '#FF7F7F')}};  width: 20px; height: 20px;"></div>
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											<!--begin::Form-->
												...
												<div class="modal-header">
													<!--begin::Modal title-->
													<h2 style="margin-left: 177px;" class="fw-bolder" data-kt-calendar="title">Copy <span id="copy_shift_title"></span> Shifts</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
													<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
														<!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<button  style="background-color: whitesmoke;color: midnightblue;" class="check btn btn-primary">Select All</button>
													<button style="background-color: whitesmoke;color: midnightblue;" class="uncheck btn btn-primary">Clear All</button>
													</div>
													<div id="weekList">
												...
												<div class="modal-footer flex-center">
													...
													<!--end::Button-->
													<!--begin::Button-->
													<input style="margin-left: 252px;" type="checkbox" name="remove_staff"><label>Remove staff from shifts.</label>
													<button id="shifts_next_modal" type="submit" id="kt_modal_add_event_submit eventsaveBtn" class="btn btn-primary">
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											<!--begin::Form-->
												...
												<div class="modal-header">
													<!--begin::Modal title-->
													<h2 style="margin-left: 177px;" class="fw-bolder" data-kt-calendar="title">Copy which day and site</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
													<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
														<!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
											  ...
											  <label >Moblie App</label>&nbsp&nbsp
														...
														<div class="col-12" style="margin-left: 39px;">
															<ul class="ks-cboxtags">
																<li><input type="checkbox" class="custom_checkbox" id="checkboxEight" value="Mon" name="copy_weeks"><label for="checkboxEight">M</label></li>
																  <li><input type="checkbox" class="custom_checkbox" id="checkboxNine" value="Tue" name="copy_weeks"><label for="checkboxNine">T</label>
																  </li>
																  <li><input type="checkbox" class="custom_checkbox" id="checkboxTen" value="Wed" name="copy_weeks"><label for="checkboxTen">W</label></li>
																  <li class="ks-selected"><input type="checkbox" class="custom_checkbox" id="checkboxEleven" value="Thu" name="copy_weeks"><label for="checkboxEleven">T</label></li>
																  <li><input type="checkbox" class="custom_checkbox" id="checkboxTwelve" value="Fri" name="copy_weeks"><label for="checkboxTwelve">F</label></li>
																  <li><input type="checkbox" class="custom_checkbox" id="checkboxThirteen" value="Sat" name="copy_weeks"><label for="checkboxThirteen">S</label></li>
																<li><input type="checkbox" class="custom_checkbox" id="checkboxFifteen" value="Sun" name="copy_weeks"><label for="checkboxFifteen">S</label></li>
															</ul>
														</div>
														<div class="col-12" style="margin-top: -16px;">
															<button style="background-color: gray;border: none;color: white;" type="button" class="btn-primary btn-sm" onclick="pay_charge_history('payrate')"> Select All </button>
															<button style="background-color: gray;border: none;color: white;" type="button" class="btn-primary btn-sm" onclick="pay_charge_history('chargerate')"> Select None </button>
														</div>
												...
												<div class="modal-footer flex-center">
													...
													<!--end::Button-->
													<!--begin::Button-->
													<button style="margin-left: 325px;" id="kt_modal_shifts_prev" class="btn btn-white me-3">Prev</button>
													<button id="shifts_next_modal" type="submit" id="kt_modal_add_event_submit eventsaveBtn" onclick="copyShifts()" class="btn btn-primary">
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											...
											<!-- {{-- <form class="form" action="#" id="savesiteFormNew" > --}} -->
												...
												<div class="modal-header">
													<!--begin::Modal title-->
													<h2 style="margin-left: 157px;" class="fw-bolder ml-5" data-kt-calendar="title">Publish for <span class="publish_customer_names"></span></h2>
													<!--end::Modal title-->
													<!--begin::Close-->
													<div id="close_publish_modal" class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
														<!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
														<span  class="svg-icon svg-icon-1">
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g transform="translate(12.000000, 12.000000) rotate(-45.000000) translate(-12.000000, -12.000000) translate(4.000000, 4.000000)" fill="#000000">
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="row">
														<div class="col-12" style="margin-left: 120px;">
															<button type="button" class="btn-primary btn-sm" onclick="getPublishList('guard')"> Publish By Person </button>
															<button type="button" class="btn-primary btn-sm" onclick="getPublishList('site')"> Publish By Site </button>
														</div>
														<div class="col-12" style="margin-left: 160px;margin-top:20px;">
														...
														<div class="col-12" style="margin-left: 39px;">
															<ul class="ks-cboxtags">
																...
																<li><input type="checkbox" class="custom_checkbox" id="checkboxOne" value="Mon" name="days_selected"><label for="checkboxOne">M</label></li>
																<li><input type="checkbox" class="custom_checkbox" id="checkboxTwo" value="Tue" name="days_selected"><label for="checkboxTwo">T</label></li>
																<li class="ks-selected"><input type="checkbox" class="custom_checkbox" id="checkboxThree" value="Wed" name="days_selected"><label for="checkboxThree">W</label></li>
																<li><input type="checkbox" class="custom_checkbox" id="checkboxFour" value="Thu" name="days_selected"><label for="checkboxFour">T</label></li>
																<li><input type="checkbox" class="custom_checkbox" id="checkboxFive"value="Fri" name="days_selected"><label for="checkboxFive">F</label></li>
																<li><input type="checkbox" class="custom_checkbox" id="checkboxSix" value="Sat" name="days_selected"><label for="checkboxSix">S</label></li>
																<li><input type="checkbox" class="custom_checkbox" id="checkboxSeven" value="Sun" name="days_selected"><label for="checkboxSeven">S</label></li>
															  </ul>
														</div>
														<div class="col-12" style="margin-top: -16px;">
															<button style="background-color: gray;border: none;color: white;" type="button" class="btn-primary btn-sm" onclick="pay_charge_history('payrate')"> Select All </button>
												...
												<div class="modal-footer flex-center">
													...
													<!--end::Button-->
													<!--begin::Button-->
													<button style="margin-left: 324px;"  id="addPublishNextBtn" data-toggle="modal" data-target="#addPublishNext" class="btn btn-primary">
													<span>Next</span>
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											<!--begin::Form-->
												...
												<div class="modal-header">
													<!--begin::Modal title-->
													<h2 style="margin-left: 146px;" class="fw-bolder ml-5" data-kt-calendar="title">Publish for <span class="publish_customer_names"></span></h2>
													<!--end::Modal title-->
													<!--begin::Close-->
													<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
														<!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="row">
														<div class="col-12" style="margin-left: 30px;">
															<label>Choose the notification method: </label>&nbsp&nbsp&nbsp
															<input class="checkbox" type="checkbox" name="notification" value="email">&nbsp
											  <label >Email</label>&nbsp&nbsp
											  <input class="checkbox1"  type="checkbox" name="notification" value="push">&nbsp
											  <label >Moblie App</label>&nbsp&nbsp
												...
												<div class="modal-footer flex-center">
													<!--begin::Button-->
													<button id="kt_modal_add_publish_cancel" class="btn btn-white me-3" data-bs-dismiss="modal">Cancel</button>
													<!--end::Button-->
													<!--begin::Button-->
													{{-- prev start --}}
													<button style="margin-left: 228px;" id="kt_modal_add_publish_prev" class="btn btn-white">Prev</button>
													{{-- prev end --}}

													<button id="addPublishNextBtn" data-toggle="modal" data-target="#addPublishNext" class="btn btn-primary" onclick="publishRoster()">
				...
				@if(session()->get('userType')=='admin' || session()->get('userType')=='customer')
														...
														<div class="position-relative me-md-2">
															<div class="row" style="border: 1px solid black;box-shadow: 5px 10px #888888">
																...
																<div class="col-sm-12 col-md-3 col-lg-2 mb-8 ">
																	...
																	<!-- <select class="form-select form-select-solid" data-control="select2" data-placeholder="" data-hide-search="true" id="customer-selection" name="customer-selection[]" multiple=""> -->
																	<select onchange="get_customers_jobs_list_filter()" name="customer-selection[]"  id="customer-selection" multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1">
																		<input type="hidden"  class="client_id" name=""  value="{{session()->get('customer_id')}}">
										...
										<div id="search_value_div" class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
											...
											<label  class="fs-6 form-label fw-bolder text-dark">Select Sites</label>
																	<div  class="fv-row mb-10">
																	<select multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1"  name="search_value[]" id="search_value" data-placeholder="Select an option">
																		<input type="hidden"  class="site_id" name=""  value="{{session()->get('site')}}">
							...
							@if($is_super_admin == 1 || (isset($permissions['roster_action']) && $permissions['roster_action'] == true))
													...
													<button  type="button" class="btn btn-action ml-2"  id="addPublishBtn" data-toggle="modal" data-target="#addPublish" data-backdrop="static" data-keyboard="false" style="margin-left: 5px;">Publish <span id="unpublish-count"></span></button>
...
<script type="text/javascript">
	var view_by_guard = "{{(($is_super_admin == 1 || (isset($permissions['view_by_guard']) && $permissions['view_by_guard'] == true)) ? true : false)}}";
	var site_edit_delete = "{{(($is_super_admin == 1 || (isset($permissions['site_edit_delete']) && $permissions['site_edit_delete'] == true)) ? true : false)}}";
	var roster_shifts_control = "{{(($is_super_admin == 1 || (isset($permissions['roster_shifts']) && $permissions['roster_shifts'] == true)) ? true : false)}}";
	var rosterControl = "{{(($is_super_admin == 1 || (isset($permissions['rosterControl']) && $permissions['rosterControl'] == true)) ? true : false)}}";
</script>
							@stop
