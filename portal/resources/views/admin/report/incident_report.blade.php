                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                    ...
                    <div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            <!--begin::Heading-->
                            <h1 class="text-dark fw-bolder my-0 fs-2">Incident Report Page</h1>
                            <!--end::Heading-->
                        </div>
                        <!--end::Page title=-->
                        <!--begin::Wrapper-->
                            ...
                            <div class="card " style="margin-bottom: 10px;">
                                    ...
                                    <div class="row">
                                                            ...
                                                            <div class="col-sm-6 ">
                                                              ...
                                                              <div class="col-sm-2" >
                                                                  <button type="button" onclick="get_incident_report()" style="margin-top:30px" class="btn btn-primary">Get Reports</button>
                                                              </div>
                                                        </div>
...
function get_incident_report(){
    var customer_id=$("#customer_name").val();
    var site_id=$("#site").val();

$.ajax({type: "POST",url:"{{url('report/get_incident_report/')}}",data:{customer_id:customer_id,site_id:site_id, _token :'<?php echo csrf_token() ?>'},success: function(result){
    console.log(result);
...
data.job_end="N/A";
            ...
            list += '<td style="display:;">'+data.incident_date +'<span >(  '+  data.incident_time +'  )</span></td>';
            list += '<td style="display:"><a target="__blank" href="{{url('guard/incident_report_pdf')}}/'+data.incident_id+'" >Download</a></td>';
            list += '</tr>';
                });
