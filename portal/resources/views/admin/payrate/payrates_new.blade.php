														...
														<form id="payrates-form" class="form" action="{{url('create_payrate')}}" method="POST" enctype="multipart/form-data"> @csrf
															...
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																...
																<!--begin::Input group-->
																	...
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<input type="hidden" id="payrate_id" name="payrate_id" style="display:none;"/>
																	...
																	<div class="row" style="display:none;">
																		<div class="col-4">
																			<div class="form-check form-check-custom form-check-solid me-10 site-filters" style="padding-top:27px;">
																				<input class="form-check-input filter_sites h-30px w-30px" type="radio" name="payrate_type" value="abn" id="payrate_type">
																		...
																		<div class="col-4">
																			<div class="form-check form-check-custom form-check-solid me-10 site-filters" style="padding-top:27px;">
																				<input class="form-check-input filter_sites h-30px w-30px" type="radio" name="payrate_type" value="eba" id="payrate_type">
																				<label class="form-check-label" for="flexRadio30">
																					EBA
																				</label>
																			</div>
																		...
																		<!-- <div class="col-4">
																			<div class="form-check form-check-custom form-check-solid me-10 site-filters" style="padding-top:27px;">
																				<input class="form-check-input filter_sites h-30px w-30px" type="radio" name="payrate_type" value="award" id="payrate_type">
																				<label class="form-check-label" for="flexRadio30">
																					Award
																				</label>
																			</div>
																...
																<!-- <div class="row rates-section">
																	...
																	<div class="row rates-section eba_rate" style="display: none !important;" id="eba_rates" >
																		<div class="col-md-12">
																			<div class="rTable">
																				<div class="rTableBody">
																					<div class="rTableRow">
					...
					<div class="modal-dialog modal-dialog-centered mw-650px">
						...
						<div class="modal-content">
							...
							<div class="modal-body modal_custom_body scroll-y mx-5 mx-xl-15 my-7 modal_card_custom">
								...
								<form id="payrates-form_add" class="form" action="{{url('create_payrate_new')}}" method="POST" enctype="multipart/form-data"> @csrf
									<!--begin::Scroll-->
									<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
										<!--begin::Input group-->
										<div class="fv-row mb-7">
										...
										<div class="fv-row mb-7" style="display:none;">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<select class="form-select form-select-lg form-select-solid" data-placeholder="Select..." name="customer_id">
												<option value="">Select Customer</option>
												@foreach($customers as $customer)
												<option value="{{$customer->id}}">{{$customer->name}}</option>
												@endforeach
										...
										<!--begin::Input group-->
																	...
																	<div class="row" style="display:none;">
																		<div class="col-4">
																			<div class="form-check form-check-custom form-check-solid me-10 site-filters" style="padding-top:27px;">
																				<input class="form-check-input filter_sites h-30px w-30px" type="radio" name="payrate_type" value="abn" id="payrate_type" {{$rate_type == 'abn' ? 'checked' : ''}}>
																				<label class="form-check-label" for="flexRadio30">
																					ABN
																				</label>
																			</div>
																		...
																		<div class="col-4">
																			<div class="form-check form-check-custom form-check-solid me-10 site-filters" style="padding-top:27px;">
																				<input class="form-check-input filter_sites h-30px w-30px" type="radio" name="payrate_type" value="eba" id="payrate_type" {{$rate_type == 'eba' ? 'checked' : ''}}>
																				<label class="form-check-label" for="flexRadio30">
																					EBA
																				</label>
																			</div>
																	...
																	<div class="row default_rates" style="display: non;">
																		<div class="col-md-12">
																			<div class="rTable">
																				<div class="rTableBody">
																					<div class="rTableRow">
																...
																<hr>
																<!-- <div class="row rates-section eba_rates" style="display: none;">
																	<div class="col-md-6">
																		<h4 class="text-center">EBA-Awards</h4></div>
																	</div> -->
																	<div class="row rates-section eba_rates" style="display: none;">
												...
												Swal.fire({
													...
													t.value ? (
														$.ajax({type: "POST",url: `{{url('delete_payrate')}}/${id}`, data:{_token:'<?php echo csrf_token();?>'},success: function(result){
															...
															window.location.href = "{{ url('/payrates_new')}}?type={{$rate_type}}";
   ...
   //     	$('#payrate-modal').click({
     ...
     // e.preventDefault();
											...
											function savePayrate()
											{
												...
												$.ajax({type: "POST",url: "{{url('create_payrate_customized')}}",data : data,success: function(result){if(result.success){
													Swal.fire({
												...
												$.ajax({
													...
													success: function(result){
														if (result.success) {
															...
															$("input[name=payrate_type][value='"+result.payrates.payrate_type+"']").prop("checked",true);
															if(result.payrates.payrate_type == 'default')
															{
																$('.default_rates').css('display', '');
																$('.eba_rates').css('display', 'none');
															}else{
																$('.default_rates').css('display', 'none');
																$('.eba_rates').css('display', '');
															}
