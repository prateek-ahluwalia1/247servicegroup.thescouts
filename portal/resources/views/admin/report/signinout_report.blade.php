...
<div class=" content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="position-relative w-md-400px me-md-2">
                        <label class="fs-6 form-label fw-bolder text-dark">From - To</label>
                                    ...
                                    <div class="position-relative w-md-400px me-md-2">
                                        ...
                                        <select multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1" id="customer_id" name="customer_id[]" multiple="">
                        ...
                        <div style="display:" id="kt_advanced_search_form">
                            ...
                            <div class="row ">
                                   ...
                                   <!--  <div class="col-lg-6 ">
                                        ...
                                        <!-- <div id="div_inactive" class="col-lg-6 ">
                                            <label class="fs-6 form-label fw-bolder text-dark">Select 
                                                Sites</label>
                                            <div class="fv-row mb-10"><select multiple multiselect-search="true"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="button" onclick="invoice_report_data(this)" id="excel-btn" value="Excel"  class="btn btn-success me-5"/>
                                    </div>
                                        <!-- <div class="col-sm-2">
            ...
            <script>
                ...
                function invoice_report_data(e){
                    ...
                    if($(e).val() == "Excel" ){
                        ...
                        var state=$('#state').val();
                        var sites=$('#sites').val();
                        var url = "{{url('report/generate_signinout_report/')}}?customer_id="+customer_id+"&date="+date
	...
	//  console.log(html_bb);
     	...
     	// $('#operation_notes_modal').modal('hide');
            ...
            //          <div  class="fv-row mb-10"><select multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1" id="sites" name="sites[]" data-control="select2" data-placeholder="Select an option">`;
