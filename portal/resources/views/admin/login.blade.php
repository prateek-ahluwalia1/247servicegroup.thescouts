...
<html lang="en">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{asset('')}}media/illustrations/progress-hd.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					{{-- <a href="index.html" class="">
						<img alt="{{ config('custom.title')}}" src="{{config('custom.logo')}}" class="h-60px" />
					</a> --}}
					...
					<div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="" action="{{ url('do_login')  }}" method="POST">
							@csrf
							<!--begin::Heading-->
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">{{ config('custom.title')}}</h1>
								<h5 class="text-dark mb-3" >Login to Admin</h5>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input required class="form-control form-control-lg form-control-solid" type="email" name="email" autocomplete="off" required />
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								...
								<!--end::Wrapper-->
								<!--begin::Input-->
								<input required class="form-control form-control-lg form-control-solid" type="password" name="password" autocomplete="off" required />
								<!--end::Input-->
							</div>
							...
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									<!--begin::Label-->
									<label class="form-label fw-bolder text-dark fs-6 mb-0">OTP</label>
									<!--end::Label-->
									<!--begin::Link-->
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" type="text" name="otp" autocomplete="off" required="">
								<!--end::Input-->
							</div>
							@endif
							<!--end::Input group-->
   ...
   toastr.options = {
			...
			toastr.error('Session expired. Please refresh page again!', 'Session Expired');
}, 30000);
		</script>
		@if(session('msg'))
<script type="text/javascript">
