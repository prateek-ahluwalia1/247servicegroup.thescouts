<div class="fv-row mb-9">
															<!--begin::Timeline-->
                      <div class="timeline">
                      		@foreach($foot_patrol_report as $footpatrol_report)
															...
															<div class="d-flex align-items-center border border-dashed border-gray-300 rounded  p-5">
																...
																<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
																	...
																	<div class="ms-1 fw-bold">
																		<!--begin::Desc-->
																		<a href="{{url('guard/foot_patrol_report_pdf/'.$footpatrol_report->id)}}" target="_blank" class="fs-6 text-hover-primary fw-bolder">Download</a>
																		<!--end::Desc-->
																		<!--begin::Number-->
																		<div class="text-gray-400">StartAt: {{date('d/m/Y H:i', strtotime($footpatrol_report->clicked_at))}}</div>
																		<div class="text-gray-400">Submission Time: {{date('d/m/Y H:i', strtotime($footpatrol_report->created_at))}} </div>
																		<!--end::Number-->
																	</div>
																	<!--begin::Info-->
																</div>
