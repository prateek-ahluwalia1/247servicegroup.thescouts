@section('profile_tracker')

<div class="tab-pane fade" id="kt_user_view_profile_tracker_tab" role="tabpanel">
                                            <!--begin::Card-->
                                    ...
                                    <div class="card card-flush h-md-100">
                                        ...
                                        <div class="card-footer flex-wrap pt-0">
                                            <button type="button" class="btn btn-white btn-active-light-primary my-1" data-bs-toggle="modal"  id="documents-modal-btn"() onclick="getContacts()">Open Traker</button>
