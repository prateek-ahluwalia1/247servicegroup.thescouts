				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-0 fs-2">Contractor Report</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
							<!--begin::Wrapper-->
					...
					<div class=" content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container" id="kt_content_container">
							<!--begin::Form-->
							<form id="search-form" class="form" action="{{url('contractor_report/contractor_report_search')}}" method="POST" enctype="multipart/form-data">
								@csrf
								<!--begin::Card-->
								<div class="card mb-7">
									<!--begin::Card body-->
													...
													<div class="row ">
														<!--begin::Col-->
															...
															<br>
															            ...
															            <select multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1" id="State" name="State[]" multiple="" class="_ac-contractor-change">
															...
															<br>
														              	...
														              	<label class="fs-6 form-label fw-bolder text-dark">Select contractor</label>
            															<div class="fv-row mb-10">
															            <select multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1" id="contractor_name" name="contractor_name[]" multiple="">
															          	@foreach($contractors as $result)
...
function get_contractors()
{
						     ...
						     $.ajax({type: "GET",url:' {{url('contractor_report/contractor_report_record/')}}',success: function(result){
