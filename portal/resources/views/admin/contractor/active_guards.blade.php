            ...
            <tr>
                ...
                <td class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        <a href="{{url('guard_profile') . '/' . $guard->id}}"
                            class="text-gray-800 text-hover-primary mb-1">{{$guard->name}}</a>
                ...
                <td>
                    ...
                    <?php 
														...
														?>
                    @if($percent<=50) <div class="progress h-5px w-100">
...
<div class="progress h-5px w-100">
    <div class="progress-bar bg-success" role="progressbar" style="width: {{$percent}}%" aria-valuenow="20"
...
<td class="text-end">
    <div class="d-flex justify-content-end flex-shrink-0">
        ...
        <a href="{{url('edit_guard')}}/{{$guard->id}}"
        ...
        <a type="button" onclick="deleteUser({{$guard->id}})"
