@extends('layout.app') @extends('layout.sidebar') @extends('layout.footer') @section('pageCss')
<base href="../../../">
<meta charset="utf-8" />
...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
	...
	<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
		...
		<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
			...
			<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
				<!--begin::Heading-->
				<h1 class="text-dark fw-bolder my-0 fs-2">ASAP Jobs</h1>
				<!--end::Heading-->
			</div>
			<!--end::Page title=-->
			<!--begin::Wrapper-->
	...
	<div class=" content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="container" id="kt_content_container">
			<!--begin::Form-->
			<form id="search-form" class="form" action="{{url('timesheet_search')}}" method="POST" enctype="multipart/form-data"> @csrf
				<!--begin::Card-->
				<div class="card mb-7">
					<!--begin::Card body-->
					<div class="card-body">
						...
						{{-- <div style="display: none" id="kt_advanced_search_form">
							...
							<div class="row ">
								...
								<div class="mb-0">
									...
									<input name="from_to" class="form-control form-control-solid" placeholder="Pick date rage" id="kt_daterangepicker_1" /> </div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="">
									<!--begin::Row-->
									<div class="row ">
										...
										<div class="col-lg-6 ">
											...
											<div class="fv-row mb-10">
												<select class="form-select form-select-lg form-select-solid _ac-customer-change" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" id="State" name="State[]" multiple="">
													<!-- <option value="">Select Customer</option> -->
													<option value=" ">Select</option> @foreach($states as $result)
													<option value="{{$result->state}}">{{$result->state}}</option> @endforeach </select>
											</div>
										</div>
										<div class="col-lg-6 ">
											<br>
											...
											<div class="fv-row mb-10">
												<select class="form-select form-select-lg form-select-solid _ac-customer-change" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" id="customer_name" name="customer_name[]">
													<!-- <option value="">Select Customer</option> -->@foreach($customers as $result)
													<option value="{{$result->id}}">{{$result->name}}</option> @endforeach </select>
											</div>
										</div>
										<div class="col-lg-6 ">
											<label class="fs-6 form-label fw-bolder text-dark">Select {{config('custom.guard')}}</label>
											<div class="fv-row mb-10">
												<select class="form-select form-select-lg form-select-solid _ac-customer-change" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" id="guard_name" name="guard_name[]" multiple="">
													<!-- <option value="">Select Customer</option> -->@foreach($guards as $result)
													<option value="{{$result->id}}">{{$result->name}}</option> @endforeach </select>
											</div>
										</div>
										<div class="col-lg-6">
										...
										<div class="col-lg-4">
											...
											<div class="nav-group nav-group-fluid">
												<!--begin::Option-->
												<label>
													<input type="radio" class="btn-check" name="status" value="all" checked="checked"> <span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bolder px-4">All</span> </label>
												<!--end::Option-->
												<!--begin::Option-->
												<label>
													<input type="radio" class="btn-check" name="status" value="completed"> <span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bolder px-4">Approved</span> </label>
												<!--end::Option-->
												<!--begin::Option-->
												<label>
													<input type="radio" class="btn-check" name="status" value="pending"> <span class="btn btn-sm btn-color-muted btn-active btn-active-primary fw-bolder px-4">Unapproved</span> </label>
												<!--end::Option-->
											</div>
											<!--end::Radio group-->
										</div>
										...
										<div class="col-lg-12 ">
											...
											<div class="fv-row mb-10">
												<select class="form-select form-select-lg form-select-solid _ac-customer-change" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" id="address" name="address[]" multiple="">
													<!-- <option value="">Select Customer</option> -->@foreach($address as $result)
													<option value="{{$result->address}}">{{$result->address}}</option> @endforeach </select>
											</div>
										</div>
									</div>
									<!--end::Row-->
