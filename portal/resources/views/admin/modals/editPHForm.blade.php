										...
										<div class="mb-0">
												<div class="tab-content" id="myTabContent">
													<div class="tab-pane fade fade active show" id="shift_details" role="tabpanel">
														<!--begin::Input group-->
											<input type="hidden" id="phId" value="{{$ph->id}}" >
											<div class="fv-row mb-9">
												...
												<input type="text" class="form-control form-control-solid" placeholder="" name="holiday_name" id="holiday_name" value="{{$ph->holiday_name}}" />
											...
											<div class="fv-row mb-9">
												...
												<!--end::Label-->
												<textarea class="form-control form-control-solid" placeholder="" name="holiday_information" id="holiday_information">{{$ph->information}}</textarea>
											</div>
											...
											<div class="fv-row mb-9">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control form-control-solid date-time" placeholder="" name="event_starts" id="event_starts" value="{{date('d-m-Y', strtotime($ph->date))}}" />
												<!--end::Input-->
											</div>
...
<!--begin::Demo-->
                ...
                <div class="text-center" id="kt_explore_footer" style="margin-top: 10%;">
					...
					<button type="submit" class="btn btn-success" id="deleteEventFormBtn" onclick="deleteShift({{$ph->id}})">Delete</button>
				</div>
...
function submitForm(notify = true)
{
  ...
  {
  	Swal.fire({text:"Do you confirm delete this Public Holiday?",
       icon:"success",
       showCancelButton:!0,
       buttonsStyling:!1,
   ...
   if (e.value == true) {
      $.ajax({
        ...
        success: function(result) {
            if (result.success == true) {
                Swal.fire({
                   text:"Your Public Holiday delete successfully.",
                   icon:"success",
                   buttonsStyling:!1,
                   confirmButtonText:"Ok, got it!",
                   customClass:{
