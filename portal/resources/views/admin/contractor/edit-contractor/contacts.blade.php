                                    ...
                                    <div class="card card-flush h-md-100">
                                        ...
                                        <div class="card-body pt-1">
                                            <table class="table table-responsive">
                                                ...
                                                <tbody id="contacts-data-listing">
                                                </tbody>
                                            </table>
                                        </div>
                                        <!--end::Card body-->
...
<div class="modal fade" id="contacts-modal" tabindex="-1" aria-hidden="true">
        ...
        <form id="contacts-form"  action="{{url('contractor/save_contacts')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
 
  <input type="hidden" class="form-control form-control-md" name="contractor_id" value="{{$contractor_id}}">
  <input type="hidden" id="index_counter" name="index_counter" value="">
 <div id="contacts_container2">
  {{-- <input type="hidden" id="index_counter" name="cid[0]" value="">
    ...
    <div class="row">
        <div class="col-md-4 form-group">
            ...
            <input type="text" class="form-control form-control-md" name="contact_name[0]">
        </div>
        <div class="col-md-4 form-group">
            <label for="recipient-name" class="col-form-label">Email</label>
            <input type="email" class="form-control form-control-md"  name="contact_email[0]">
        </div>
        <div class="col-md-4 form-group">
            <label for="recipient-name" class="col-form-label">Phone</label>
            <input type="phone" class="form-control form-control-md"  name="contact_phone[0]">
        </div>
    </div> --}}
