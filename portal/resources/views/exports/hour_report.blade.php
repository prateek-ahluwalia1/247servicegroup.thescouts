<table>
 <thead>
  <tr>
    <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">State</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Site Name</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Site Level</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">{{config('custom.guard')}} Name</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">{{config('custom.guard')}} External ID</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">{{config('custom.guard')}} Phone</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Customer</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Schedule Start Date</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Schedule Start Time</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Schedule Finish Time</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Authorized Total Hours</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Actual Hours</th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Monday to Friday Day </th>
  
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Monday to Friday Night </th>
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Saturday </th>
   <!-- <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Saturday Night Hours</th> -->
   
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Sunday </th>
   
   <!-- <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Sunday Night Hours</th> -->
   
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Pub. Hol. Hours</th>
  @if(config('custom.shift_po') == 1)
   <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">P.O/W.O</th>
   <!-- <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Site P.O/W.O</th> -->
   @endif
   <!-- <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Break Payable</th> -->
   <!-- <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Break Deduction</th> -->
   <!-- <th style="text-align:center; background-color: #FFFF00;border:1px solid #000000; font-size: 14px;width: 100px;">Travel Time Hours</th> -->
...
<tr>
  ...
  @if(config('custom.shift_po') == 1)
  <td style="text-align:center;border:1px solid #000000;">{{$val['pw_order'] != '' ? $val['pw_order'] : $val['site_pw_order']}}</td>
...
@endforeach
 <tr>
  ...
  @if(config('custom.shift_po') == 1)
  <td style="text-align:right; background-color: #8DB4E2; border:1px solid #000000;"></td>
  <!-- <td style="text-align:right; background-color: #8DB4E2; border:1px solid #000000;"></td> -->
   @endif
