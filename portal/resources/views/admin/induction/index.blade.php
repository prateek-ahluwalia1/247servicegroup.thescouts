					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-0 fs-2">Induction</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
							<!--begin::Wrapper-->
							...
							<div class="card">
								...
								<div class="card-body p-0">
									...
									<div class="card-px text-center py-20 my-10">
										<!--begin::Title-->
										<h2 class="fs-2x fw-bolder mb-10">New Induction</h2>
										<!--end::Title-->
										<!--begin::Description-->
										
										<!--end::Description-->
										<!--begin::Action-->
										<a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#induction_modal">Add New Induction</a>
										<!--end::Action-->
									</div>
									@endif
											...
											<div class="col-md-4">
												<div class="card-xl-stretch me-md-6">
													<div class="overlay mt-8">
														<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('{{asset('')}}media/induction.jpeg')"></div>
														<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
															<a class="action_button  btn btn-icon btn-circle btn-active-color-primary bg-white shadow" href="{{url('induction')}}/{{$result->id}}" style="margin: 9px;" >view</a>
															@if(session()->get('userType')=='admin')
													...
													<div class="mt-5">
														<a href="#" class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">{{$result->title}}</a>
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content rounded">
										...
										<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
											<!--begin:Form-->
											<form id="induction-form" action="{{url('add_induction')}}" class="form"  method="POST" enctype="multipart/form-data">
                                                @csrf
												<!--begin::Heading-->
												<div class="mb-13 text-center">
													<!--begin::Title-->
													<h1 class="mb-3">Add Induction</h1>
													<!--end::Title-->
													<!--begin::Description-->
													<div class="text-gray-400 fw-bold fs-5">You can specify your induction below
												...
												<div class="d-flex flex-column mb-8 fv-row">
													...
													<label class="d-flex align-items-center fs-6 fw-bold mb-2">
														...
														<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a induction name for future usage and reference"></i>
													</label>
													<!--end::Label-->
													<input type="text" class="form-control form-control-solid" placeholder="Enter Induction Title" name="title" id="title" />
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
                                                ...
                                                <div class="row g-9 mb-8">
                                                    ...
                                                    <div class="col-md-6 fv-row" id="send_to_guards_div">
														...
														<select multiple multiselect-search="true" multiselect-select-all="true" multiselect-max-items="1" id="send_to_guards" name="send_to_guards[]">
							...
							<div class="modal fade" id="induction_modal_edit" tabindex="-1" aria-hidden="true">
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content rounded">
										...
										<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
											<!--begin:Form-->
											<form id="induction-form_edit" action="{{url('edit_induction')}}" class="form"  method="POST" enctype="multipart/form-data">
                                                @csrf
												<!--begin::Heading-->
												<div class="mb-13 text-center">
													<!--begin::Title-->
													<h1 class="mb-3">Change Induction</h1>
													<!--end::Title-->
													<!--begin::Description-->
													<div class="text-gray-400 fw-bold fs-5">You can specify your induction below
													<a href="#" class="fw-bolder link-primary"></a>.</div>
                                                ...
                                                <div class="row g-9 mb-8">
                                                    ...
                                                    <div class="col-md-6 fv-row" id="send_by_list_div_edit">
														<label class="required fs-6 fw-bold mb-2">Select</label>
														<select class="form-select form-select-solid  " data-control="select2" data-dropdown-parent="#induction_modal_edit" data-placeholder="Select  {{config('custom.guard')}} " id="send_by_list_edit" name="send_by_list_edit">
								...
								<div class="modal fade" id="card_modal" tabindex="-1" aria-hidden="true">
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="d-flex align-items-center position-relative my-1">
											...
											<!--end::Svg Icon-->
											<input type="text" id="search_card"  class="form-control form-control-solid w-250px ps-14" placeholder="Search user" />
										</div>
										<!--end::Search-->
													</div>
													<div id="induction-table">
...
$('#search').keyup(function() {
  ...
  if (image != '') {
  	 $.ajax({
        type: "POST",
        url: "{{url('upload_image_induction')}}",
...
function update_induction(id){
		...
		console.log(this.id)
     	...
     	$.ajax({type: "POST",url: this.action,data : data ,success: function(result){if(result.success){
     		$('#induction_modal_edit').modal('hide');
					...
					window.location.href = "{{ url('/inductions')}}";
     }else{Swal.fire({
                        text: result.error,
                        icon: "error",
                        buttonsStyling: !1,
  ...
  function delete_induction(id){
	...
	Swal.fire({
                        ...
                        t.value ? (
							$.ajax({type: "POST",url: `{{url('delete_induction')}}/${id}`, data:{_token:'<?php echo csrf_token();?>'},success: function(result){
								Swal.fire({
...
$('#send_by_list').change(function(){
  ...
  function load_send_by_list(send_by, send_by_list_id = null){
        ...
        type: "POST",
        data: {send_by : send_by,_token:'<?php echo csrf_token();?>'},
        url: "{{url('get_send_by_list_induction')}}",
        success: function(result){
...
function get_induction_images(id){
	...
	// ('#card_induction_body_table').DataTable().destroy();
	$('#induction-table').html(`<table id="card_induction_body_table" class="table table-striped ">
														<thead>
															<tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
																<th>{{config('custom.guard')}} Name</th>
																<th>{{config('custom.guard')}} Induction Card</th>
...
$.ajax({
		  type: "POST",
        data: {id : id,_token:'<?php echo csrf_token();?>'},
        url: "{{url('get_induction_images')}}", 
  success: function(result){
    //   result = JSON.parse(result);
      var options= '';
      $.each(result, function(id, data){
		// data.picture= `{{asset('')}}${data.image}`;
		options += `<tr><td>${data.name}</td><td style="text-align:end"><a href="${data.image}" style="font-size: 11px;" class="btn btn-primary" download>Download</a> <a style="font-size: 11px;" target="__blank" href="${data.image}" class="btn btn-primary">View Card</a></td></tr>`;
		// console(data.picture);
		//   options += `<div class="col-md-4">
		// 										<div class="card-xl-stretch me-md-6">
		// 											<span class="d-block overlay" data-fslightbox="lightbox-hot-sales" >
		// 												<a href="${data.image}" target="_blank" >
		// 												<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('${data.picture}')"></div></a>
		// 												<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
		// 												</div>
		// 											</span>
		// 											<div class="mt-5">
...
function induction_seen_status(id){
	$.ajax({type: "POST",url:"{{url('induction_seen_status')}}",data:{id:id,_token:'<?php echo csrf_token();?>'} ,success: function(result){
		var html='';
