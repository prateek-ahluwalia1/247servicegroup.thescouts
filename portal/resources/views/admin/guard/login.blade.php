				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #F2C98A">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to {{ config('custom.title');}}</h1>
                            <h4>{{config('custom.guard')}} Login</h4>
                            <!--end::Title-->
							<!--begin::Description-->
							<!-- <p class="fw-bold fs-2" style="color: #986923;">Discover Amazing {{ config('custom.title');}}
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_for" action="{{ url('do_login_guard')  }}" method="post">
								<!--begin::Heading-->
								@csrf 
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to {{ config('custom.title');}}</h1>
									<!--end::Title-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
