...
class Contractor_report extends Model
{
    ...
    public function get_search_record()
    {
       ...
       ->join('contractors', 'jobs.contractor_id', '=', 'contractors.id')
       ->join('guards', 'contractors.id', '=', 'guards.contractor_id')
    ...
    public function get_records($status){
          ...
          //   ->leftJoin('guard_ids', 'customers.id', '=', 'guard_ids.customer_id')
            ...
            'contractors.email AS contractor_email' ,
            'contractors.phone AS contractor_phone' ,
            'contractors.charged_rates_id AS contractor_charge_rate_id' ,
          ...
          //   'guard_ids.internal_id' ,
            ...
            'contractors.flat_metro_week_day',
            'contractors.eba_metro_weekday_day'
