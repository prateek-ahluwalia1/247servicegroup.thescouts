	...
	@if(!empty($break_details) && count($break_details) > 0)
						<div class="timeline-item">
													...
													<div class="timeline-content mb-10 mt-n1">
														...
														<div class="pe-3 mb-5">
															<!--begin::Title-->
															<div class="fs-5 fw-bold mb-2">Break Details:</div>
															<!--end::Title-->
															<!--begin::Description-->
														...
														<div class="overflow-auto pb-5">
															...
															<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-350px px-7 py-3 mb-5">
																<!--begin::Title-->
																<a href="#" class="fs-5 text-dark text-hover-primary fw-bold min-w-200px">Notes: {{$break->notes != '' ? $break->notes : '--'}}</a>
																<!--end::Title-->
															</div>
															<!--end::Record-->
															<!--begin::Record-->
															<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-350px px-7 py-3 mb-5">
																<!--begin::Label-->
																<div class="pe-2">
																	<span class="badge badge-light">Break Start: {{$break->start_time != '' ? date('d/m/Y H:i', strtotime($break->created_at)) : 'N/A'}}</span>
																</div>
															</div>
															<!--end::Record-->
															...
															<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-350px px-7 py-3 mb-5">
																<div class=" pe-2">
																	<span class="badge badge-light-primary">Break End: {{$break->end_time != '' ? date('d/m/Y H:i', strtotime($break->updated_at)) : 'N/A'}}</span>
																</div>
															</div>
															<!--end::Record-->
															@endforeach
