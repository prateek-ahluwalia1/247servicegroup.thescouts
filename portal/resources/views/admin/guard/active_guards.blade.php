									...
									<table class="table align-middle table-row-dashed fs-6 gy-5 table-responsive" id="table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px">Active {{config('custom.guard')}}</th>
										...
										<tbody class="text-gray-600 fw-bold">
											...
											<tr>
												...
												<td>
													<div class="form-check form-check-solid form-switch fv-row">
														...
														<input class="form-check-input w-45px h-30px" type="checkbox" id="active_inactive_status" name="active_inactive_status" onchange="admin_approval_status({{$guard->id}},this)" checked="checked">
														@else

														<input class="form-check-input w-45px h-30px" type="checkbox" id="active_inactive_status" name="active_inactive_status" onchange="admin_approval_status({{$guard->id}},this)" >
											...
											<td>
													<div class="form-check form-check-solid form-switch fv-row">
														...
														<input class="form-check-input w-45px h-30px" type="checkbox" id="approval_status" name="approval_status" onchange="guard_active_inactive_status({{$guard->id}},this)" checked="checked">
														@else

														<input class="form-check-input w-45px h-30px" type="checkbox" id="approval_status" name="approval_status"onchange="guard_active_inactive_status({{$guard->id}},this)" >
