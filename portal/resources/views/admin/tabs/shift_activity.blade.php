                      ...
                      <div class="timeline">
                      	...
                      	<div class="timeline-item">
													...
													<div class="timeline-content mb-10 mt-n1">
														...
														<div class="mb-5 pe-3">
															<!--begin::Title-->
															<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">{{$act->activity}}</a>
															<!--end::Title-->
															<!--begin::Description-->
															<div class="d-flex align-items-center mt-1 fs-6">
																<!--begin::Info-->
																<div class="text-muted me-2 fs-7">at {{date('d-m-Y H:i', strtotime($act->created_at))}} {{ isset($act->by) ? ' By '.$act->by : '';}} </div>
																<!--end::Info-->
																<!--begin::User-->
															...
															<div class="d-flex align-items-center border border-dashed border-gray-300 rounded  p-5">
																...
																<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
																	...
																	<div class="ms-1 fw-bold">
																		...
																		<!--end::Desc-->
																		<!--begin::Number-->
																		<div class="text-gray-400">{{date('d-m-Y H:i', strtotime($act->created_at))}} {{ isset($act->by) ? ' By '.$act->by : '';}}</div>
																		<!--end::Number-->
																	</div>
																	<!--begin::Info-->
																</div>
						...
						<div class="timeline-item">
													...
													<div class="timeline-content mb-10 mt-n1">
														...
														<div class="pe-3 mb-5">
															<!--begin::Title-->
															<div class="fs-5 fw-bold mb-2">Green Call:</div>
															<!--end::Title-->
															<!--begin::Description-->
															<div class="d-flex align-items-center mt-1 fs-6">
																<!--begin::Info-->
														...
														<div class="overflow-auto pb-5">
															...
															<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-350px px-7 py-3 mb-5">
																<!--begin::Title-->
																<a href="#" class="fs-5 text-dark text-hover-primary fw-bold min-w-200px">{{$act->activity}}</a>
																<!--end::Title-->
																<!--begin::Label-->
																<div class="pe-2">
																...
																<!--end::Label-->
																<div class=" pe-2">
																	<span class="badge badge-light-primary">{{date('d-m-Y H:i', strtotime($act->created_at))}} {{ isset($act->by) ? ' By '.$act->by : '';}}</span>
																</div>
															</div>
															<!--end::Record-->
						...
						@endif
                        @if($act->type != 'green_call' && $act->type != 'incident_report')
