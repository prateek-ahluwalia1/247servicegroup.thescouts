...
<html lang="en">
	...
	<body id="kt_body" style="background-color: #181c32;">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{asset('')}}media/illustrations/progress-hd.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" action="{{ url('/support_login')  }}" method="POST">
							@csrf
							<!--begin::Heading-->
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">{{ config('custom.title')}}</h1>
								<h5 class="text-dark mb-3" >Login to Customer</h5>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<nav class="nav nav-pills nav-justified">
								...
								<a class="nav-item nav-link " >Customer</a>
								<a class="nav-item nav-link  " href="{{url('contractor')}}">Contractor</a>
								<a class="nav-item nav-link active" href="{{url('support')}}">Support</a>
							  </nav>
							  <br>
							...
							<div class="text-center">
								<!--begin::Submit button-->
								<button type="submit" id="kt_sign_in_submi" class="btn btn-lg btn-primary w-100 mb-5">
		...
		<script type="text/javascript">
			...
			toastr.error('Invalid Login Details!', 'Invalid Login Details.');
		</script>
		@endif
	</body>
	<!--end::Body-->
