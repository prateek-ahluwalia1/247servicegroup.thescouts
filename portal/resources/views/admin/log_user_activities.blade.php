    ...
    <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
        ...
        <div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="text-dark fw-bolder my-0 fs-2">Log User Activities</h1>
                <!--end::Heading-->
            </div>
            <!--end::Page title=-->
            <!--begin::Wrapper-->
        ...
        <div class="container" id="kt_content_container">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <form id="search_form" action="{{url('fetch_log_user_activity')}}"  method="POST" enctype="multipart/form-data">
                            <div class="mb-0">
                               ...
                               <br>
                               <button type="submit" style="font-size: 10px" class="btn btn-primary">Get Record</button>
                               <br>
            ...
            <div class="card">
                ...
                <div class="table-responsive container card">
                    <table id="example" class="table table-responsive table-hover table-striped  gy-5 gs-7"
                        style="width:100%">
                        <thead>
                            <tr class="fw-bold ">
                                <th style="display:;">Action</th>
                                <th style="display:;">By User</th>
                        ...
                        <tbody id="example_body">
                            @foreach($logs as $log)
                            <tr class="">
                                <td style="display:;">{{$log->action}}</td>
                                <td style="display:;">{{$log->user}}</td>
                                <td style="display:;">{{date("d-m-y H:i",strtotime($log->created_at))}}</td>
                            </tr>
                            @endforeach
