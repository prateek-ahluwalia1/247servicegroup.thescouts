					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bolder my-0 fs-2">Customers</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
							<!--begin::Wrapper-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												...
												<!--begin::Name=-->
												<td>
													<a href="{{url('customer_profile/' . $customer->id)}}" class="text-gray-800 text-hover-primary mb-1">{{ $customer->name}}</a>
												</td>
												<!--end::Name=-->
												<!--begin::Email=-->
												<td>
												...
												<td>
													@if($customer->status=='active')
														<div class="form-check form-check-solid form-switch fv-row">											
															<input class="form-check-input w-45px h-30px" type="checkbox" id="active_inactive_status" name="active_inactive_status" onchange="inactiveCustomer({{$customer->id }})" checked="checked">
														</div>
													@else
														<div class="form-check form-check-solid form-switch fv-row">											
															<input class="form-check-input w-45px h-30px" type="checkbox" id="active_inactive_status" name="active_inactive_status" onchange="activeCustomer({{$customer->id }})" >
														</div>
													@endif
												</td>
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a	href="{{url('customer_profile')}}/{{$customer->id}}" class="menu-link px-3"  >Edit</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<a type="button" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="" onclick="deleteCustomer({{$customer->id }})" >Delete</a>
														</div>
							...
							<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content">
										<!--begin::Form-->
										<form class="form" id="kt_modal_add_customer_form" action="{{url('insertCustomer')}}" method="POST" enctype="multipart/form-data">
											...
											<div class="modal-header" id="kt_modal_add_customer_header">
												<!--begin::Modal title-->
												<h2 class="fw-bolder" id="form_head">Add a Customer</h2>
												<!--end::Modal title-->
												<!--begin::Close-->
												...
												<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
													...
													<div id="kt_modal_add_customer_billing_info" class="collapse show">
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="" name="address1" value="" id="googleaddressSearch"  required/>
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
...
<!-- 														</div>
 -->														<!--end::Input group-->
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input class="form-control form-control-solid" placeholder="" name="city" value=""  id="administrative_area_level_2" required readonly="" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
...
<select readonly="" class="form-select form-select-lg form-select-solid" name="state" id="administrative_area_level_1">
													...
													<option value="ACT">ACT</option>
															...
															<div class="col-md-6 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control form-control-solid" placeholder="" name="postcode" id="postal_code" value="" required readonly="" />
																<!--end::Input-->
															</div>
															<!--end::Col-->
														</div>
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												...
												<div class="modal-content">
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														<!--begin::Form-->
														<form id="export_user_form" class="form" action="{{url('customer/customer_pdf')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
			...
			$.ajax({
               ...
               success:function(result) {
				...
				var current_role='';
				  ...
				  document.getElementById("form_head").innerHTML = "Edit a Customer";


				document.getElementById("form_button").innerHTML = "Update!";
				    $('#kt_modal_add_customer_form').attr('action', `{{url('editCustomer')}}/${id}`);
...
Swal.fire({
					...
					t.value ? (
						$.ajax({type: "POST",url: `{{url('deleteCustomer')}}/${id}`, data:{_token:'<?php echo csrf_token();?>'},success: function(result){
							Swal.fire({
...
Swal.fire({
					...
					t.value ? (
						$.ajax({type: "POST",url: `{{url('activeCustomer')}}/${id}`, data:{_token:'<?php echo csrf_token();?>'},success: function(result){
							Swal.fire({
						text: "Deleted Succesfully.",
						icon: "success",
						buttonsStyling: !1,
...
Swal.fire({
					...
					t.value ? (
						$.ajax({type: "POST",url: `{{url('inactiveCustomer')}}/${id}`, data:{_token:'<?php echo csrf_token();?>'},success: function(result){
							Swal.fire({
						text: "Deleted Succesfully.",
						icon: "success",
						buttonsStyling: !1,
