														...
														<form id="payrates-form" class="form" action="{{url('create_payrate')}}" method="POST" enctype="multipart/form-data"> @csrf
															...
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																...
																<!--begin::Input group-->
																	...
																	<div class="row">
																		<div class="col-4">
																			<div class="form-check form-check-custom form-check-solid me-10 site-filters" style="padding-top:27px;">
																				<input class="form-check-input filter_sites h-30px w-30px" type="radio" name="payrate_type" value="default" id="payrate_type">
																	...
																	<div class="row default_rates" style="display: none !important;" id="default_rates">
																		<div class="col-md-12 " >
																			<div class="rTable">
																...
																<!-- <div class="row rates-section">
																	...
																	<div class="row rates-section eba_rates" style="display: none !important;" id="eba_rates" >
																		<div class="col-md-12">
																			<div class="rTable">
																				<div class="rTableBody">
																					<div class="rTableRow">
					...
					<div class="modal-dialog modal-dialog-centered mw-650px">
						...
						<div class="modal-content">
							...
							<div class="modal-body modal_custom_body scroll-y mx-5 mx-xl-15 my-7 modal_card_custom">
								...
								<form id="payrates-form_add" class="form" action="{{url('create_payrate_customized')}}" method="POST" enctype="multipart/form-data"> @csrf
									<!--begin::Scroll-->
									<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
										<!--begin::Input group-->
										<div class="fv-row mb-7">
										...
										<!--begin::Input group-->
																	...
																	<div class="row default_rates" style="display: none;">
																		<div class="col-md-12">
																			<div class="rTable">
																				<div class="rTableBody">
																					<div class="rTableRow">
