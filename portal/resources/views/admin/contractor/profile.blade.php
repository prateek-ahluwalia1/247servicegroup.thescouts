	...
	@extends('layout.footer')
			...
			@include('admin.contractor.edit-contractor.personal')

			@include('admin.contractor.edit-contractor.contacts')
		@include('admin.contractor.edit-contractor.documents')
	

		@include('admin.contractor.edit-contractor.pay-rates')
							...
							<div class="d-flex flex-column flex-xl-row">
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="card-body pt-0 pt-lg-1">
											...
											<div class="card">
												...
												<div class="card-body d-flex flex-center flex-column pt-12 p-9 px-0">
													...
													<div class="symbol symbol-100px symbol-circle mb-7 profile_image">
														<div  style ="background: '{{asset('')}}media/uploads/{{$contractor->image}}'"   ></div>
													</div>
													<!--end::Avatar-->
													<!--begin::Name-->
													<div id="first_user_name" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3 ">{{$contractor->name}}</div>
													<input type="hidden"  id ="picture_name"  value="{{$contractor->name}}" name="">
													<!--end::Name-->
													<!--begin::Position-->
													<div class="mb-9">
														<!--begin::Badge-->
														<div class="badge badge-lg badge-light-primary d-inline">Contractor</div>
														<!--begin::Badge-->
													</div>
													<!--end::Position-->
													<!--begin::Info-->
													...
													<div class="d-flex flex-wrap flex-center">
														...
														<div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
															<div class="fs-4 fw-bolder text-gray-700">
																<span class="w-75px" id="contractor_total_sites" ></span>
														...
														<div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3">
															<div class="fs-4 fw-bolder text-gray-700">
																<span class="w-50px" id="contractor_total_shifts" ></span>
											...
											<div class="d-flex flex-stack fs-4 py-3">
												...
												{{-- <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit contractor details">
											...
											<div id="kt_user_view_details" class="collapse show">
												<div class="pb-5 fs-6">
													...
													<div class="text-gray-600">{{$contractor->phone}}</div>
													<!--begin::Details item-->
													<!--begin::Details item-->
													<div class="fw-bolder mt-5">Email</div>
													<div class="text-gray-600">
														<a href="#" class="text-gray-600 text-hover-primary">{{$contractor->email}}</a>
													</div>
													<!--begin::Details item-->
													<!--begin::Details item-->
													<div class="fw-bolder mt-5">State</div>
													<div class="text-gray-600">{{$contractor->state}}
													</div>
													<!--begin::Details item-->
													<!--begin::Details item-->
								...
								<div class="flex-lg-row-fluid ms-lg-15">
									...
									<ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
										...
										<!--begin:::Tab item-->
										<li class="nav-item">
											<a class="nav-link text-active-primary pb-4 " data-bs-toggle="tab" href="#kt_user_view_pay_rates_tab">Pay Rates</a>
										</li>
										<!--end:::Tab item-->
						...
						<div class="card card-flush h-md-100">
							...
							<div class="card-body pt-1">
								...
								<div class="d-flex flex-column text-gray-600">
									<div class="d-flex align-items-center py-2"> <span class="bullet bg-primary me-3"></span>Name : {{$contractor->name}}</div>
									<div class="d-flex align-items-center py-2"> <span class="bullet bg-primary me-3"></span>Email : {{$contractor->email}}</div>
									<div class="d-flex align-items-center py-2"> <span class="bullet bg-primary me-3"></span>Address : {{$contractor->address}}</div>
									<div class="d-flex align-items-center py-2"> <span class="bullet bg-primary me-3"></span>Range-ID : {{$contractor->contractor_id_range}}</div>
								...
								<div class="modal-dialog modal-dialog-centered mw-650px">
									...
									<div class="modal-content">
										...
										<form id="kt_modal_update_user_form" class="form" 
														action="{{url('editcontractor/' . $contractor->id)}}" method="POST" enctype="multipart/form-data">
																    @csrf
<!-- 										<form class="form" action="#" id="">
 -->											<!--begin::Modal header-->
												...
												<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_user_header" data-kt-scroll-wrappers="#kt_modal_update_user_scroll" data-kt-scroll-offset="300px">
													...
													<div id="kt_modal_update_user_user_info" class="collapse show">
														...
														<div class="fv-row mb-7">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" class="form-control form-control-solid" placeholder="" name="user_name" value="{{$contractor->name}}" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
														<div class="fv-row mb-7">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="email" class="form-control form-control-solid" placeholder="" name="user_email" value="{{$contractor->email}}" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<!--begin::Input group-->
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											<!--begin::Title-->
											<a href="#" class="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Meeting with contractor</a>
											<!--end::Title-->
											<!--begin::Label-->
	...
	<script type="text/javascript" >
		...
		function contractor_total_sites(){
			$.ajax({type: "GET",url:"{{url('contractor_total_sites')}}" ,data : {id:"{{$contractor_id}}",_token :"{{csrf_token()}}" } ,success: function(result){
				console.log("site : " +result);

				$('#contractor_total_sites').text(result);
			}
		});
		}
		function contractor_total_shifts(){
			$.ajax({type: "GET",url:"{{url('contractor_total_shifts')}}" ,data : {id:"{{$contractor_id}}",_token :"{{csrf_token()}}" } ,success: function(result){
				console.log("site : " +result);
				$('#contractor_total_shifts').text(result);
...
$(document).ready(function() {
	getContactsPageLoad();
		getDocuments();
		contractor_total_sites();
		contractor_total_shifts();
	...
	var profileImage = $('.profile_image').text(intials);
			...
			// $.ajax({
			// 		   type:'GET',
			// 		   url:"{{url('getcontractor')}}"+ '/'+"{{session()->get('userId')}}",
...
<script type="text/javascript">
    ...
    {
		console.log(document.getElementById(i), i, 'asdfasdf');
        targetInput = j;
  ...
  if (e.files && e.files[0]) {
    ...
    FR.addEventListener("load", function(e) {
     ...
     $.ajax({
        type: "POST",
        url: "{{url('contractor/upload_files')}}",
 ...
 function save_Documents(){
							$.ajax({
						        type: "POST",
						        url: "{{url('contractor/get_contractor_documents')}}",
						        data : {contractor_id:'{{ $contractor_id }}', _token : '{{ csrf_token()}}'},
						        success: function(result){
						        	console.log(result)
 ...
 ,success: function(result){if(result.success){
					...
					window.location.href = "{{ url('/contractor_profile')}}/{{$contractor_id}}";
...
$.ajax({
						        type: "POST",
						        url: "{{url('contractor/get_personal_data')}}",
						        data : {contractor_id:'{{ $contractor_id }}', _token : '{{ csrf_token()}}'},

						        success: function(result){
						        	if (result.success == true) {
						        	$('input[name="name"]').val(result.contractor.name);
						        	$('input[name="email"]').val(result.contractor.email);
						        	$('input[name="phone"]').val(result.contractor.phone);
						        	$('input[name="address"]').val(result.contractor.address);
						        	$('#administrative_area_level_1').val(result.contractor.state);
						        	$('input[name="url"]').val(result.contractor.url);
						        	$('input[name="city"]').val(result.contractor.city);
						        	$('input[name="postalCode"]').val(result.contractor.postal_code);
...
function load_guard_payrates(){
	$.ajax({
						        type: "POST",
						        url: "{{url('contractor/get_contractor_payrates')}}",
						        data : {contractor_id:'{{ $contractor_id }}', _token : '{{ csrf_token()}}', job_level: $('#job_level').val(), state: $('#payrates_state').val()},
						        success: function(result){
						        if (result.success) {
...
$.ajax({
						        type: "GET",
						        url: "{{url('contractor/get_documents_data')}}",
						        data : {contractor_id:'{{ $contractor_id }}', _token : '{{ csrf_token()}}'},
						        ...
						        success: function(result){
									...
									var html='';
									$.each(result.documnets.extra_dcs, function (id, data) {
									var html=`<div class="col-6 col-sm-6 col-xl" style="margin-top: 17%;">
										<div class="card-header border-0">
													<input type="hidden" id="doc_index_counter" name="cid[${id}]" >
														<div class="card-title">
														<input type="text" class="form-control form-control-md" value="${data.header}"
																name="heading[${id}]" placeholder="Enter Doc Name" id="heading">
														</div>
													</div>
													<div class="card h-100 flex-center">
														<div id="doc_extraFile${id}" class="symbol symbol-60px mb-6 form-group row">

															<div class="col-sm-6" style="float:left;">
																<a target="__blank" id="doc_extraFile_a_${id}" href="{{config('custom.asset_url')}}${data.file}" style="margin-left: 123px;">
															...
															<div class="col-sm-6" style="float:right;">
																<a type="button" style="margin-left: 90px;margin-top: -16px;"
																	...
																	onclick="this.parentElement.parentElement.style.display = 'none';$('#div_extraFile${id}').show();$('#labour_hire_file_${id}').val('');$('#labour_hire_number_${id}').val('');$('#labour_hire_expiration_${id}').val( '')">
																	X
																</a>
															</div>
														</div>
														<div class="form-group files" id="div_extraFile${id}" style="display:none">
															<input type="file" accept="image/png, image/gif, image/jpeg" type="file"
																onchange="upload_file('extraFile${id}', 'labour_hire_file_${id}')"
																class="form-control form-control-md" id="extraFile${id}" name="extraFile${id}">
															<input type="hidden" name="extra_file[${id}]" id="labour_hire_file_${id}" value="${data.file}">
														</div>
														<div class=" form-group">
															<label for="recipient-name" class="col-form-label">Number</label>
															<input type="text" class="form-control form-control-md" value="${data.number}"
																name="extra_number[${id}]" id="labour_hire_number_${id}">
															<label for="recipient-name" class="col-form-label">Labour hire
																expiration</label>
															<input type="date" class="form-control form-control-md" value="${data.expiration}"
																name="extra_expiration[${id}]" id="labour_hire_expiration_${id}"> 
														</div>
														</div>
													</div>`;
											id++;

											// $('#doc_index_counter').val(id);
											$('#addMoreDocContainer').append(html);
											$('#doc_index_counter').val(id);
									});
...
$("#contacts-form").on('submit', function(e){
 ...
 ,success: function(result){if(result.success){
  ...
  var global_index=1;
function getContactsPageLoad(){

$.ajax({
						        type: "GET",
						        url: "{{url('contractor/get_contacts')}}",
						        data : {contractor_id:'{{ $contractor_id }}', _token : '{{ csrf_token()}}'},
						        ...
						        success: function(result){
						        	if (result.success == true) {
										...
										if(result.contacts.length > 0){
											...
											$('#contacts-data-listing').html(html1);
										}
						        	...
						        	if (result.success == true) {
										...
										if(result.contacts.length > 0){
											...
											if(!indexs){
												...
												html1+=`<div class="row">
													<input type="hidden" id="index_counter" name="cid[${index}]" value="${index}">	
													<div class="col-md-4 form-group">
														<label for="recipient-name" class="col-form-label">Name</label>
														<input type="text" class="form-control form-control-md" name="contact_name[${index}]">
													</div>
													<div class="col-md-4 form-group">
														<label for="recipient-name" class="col-form-label">Email</label>
														<input type="email" class="form-control form-control-md"  name="contact_email[${index}]">
													</div>
													<div class="col-md-4 form-group">
														<label for="recipient-name" class="col-form-label">Phone</label>
														<input type="phone" class="form-control form-control-md"  name="contact_phone[${index}]">
													</div>
													</div>`;
												}
												$('#guard-ids-container').append(html1);
												$('#index_counter').val(2);
											}
											$('#contacts-modal').modal('show');
...
$(document).on('click', '._ac-add-more-ids-btn', function(e) {
		...
		//   ADD MORE DOCUMENTS
$(document).on('click', '._ac-add-more-doc-ids-btn', function(e) {
           
		   var indexs= $('#doc_index_counter').val();
		   console.log("testing" + indexs);
		   var html=`<div class="col-6 col-sm-6 col-xl" style="margin-top: 17%;">
		   <div class="card-header border-0">
					<input type="hidden" id="doc_index_counter" name="cid[${indexs}]" >
						<div class="card-title">
						<input type="text" class="form-control form-control-md"
								name="heading[${indexs}]" placeholder="Enter Doc Name" id="heading">
						</div>
					</div>
					<div class="card h-100 flex-center">
						<div id="doc_extraFile${indexs}" class="symbol symbol-60px mb-6 form-group row"
							style="display: none;">

							<div class="col-sm-6" style="float:left;">
								<a target="__blank" id="doc_extraFile_a_${indexs}" style="margin-left: 123px;">
									<img src="{{asset('')}}media/svg/files/doc.svg" alt="">
							...
							<div class="col-sm-6" style="float:right;">
								<a type="button" style="margin-left: 90px;margin-top: -16px;"
									class="btn btn-primary"
									onclick="this.parentElement.parentElement.style.display = 'none';$('#div_extraFile${indexs}').show();$('#labour_hire_file_${indexs}').val('');$('#labour_hire_number_${indexs}').val('');$('#labour_hire_expiration_${indexs}').val( '')">
									X
								</a>
							</div>
						</div>
						<div class="form-group files" id="div_extraFile${indexs}">
							<input type="file" accept="image/png, image/gif, image/jpeg" type="file"
								onchange="upload_file('extraFile${indexs}', 'labour_hire_file_${indexs}')"
								class="form-control form-control-md" id="extraFile${indexs}" name="extraFile${indexs}">
							<input type="hidden" name="extra_file[${indexs}]" id="labour_hire_file_${indexs}">
						</div>
						<div class=" form-group">
							<label for="recipient-name" class="col-form-label">Number</label>
							<input type="text" class="form-control form-control-md"
								name="extra_number[${indexs}]" id="labour_hire_number_${indexs}">
							<label for="recipient-name" class="col-form-label">Labour hire
								expiration</label>
							<input type="date" class="form-control form-control-md"
								name="extra_expiration[${indexs}]" id="labour_hire_expiration_${indexs}"> 
						</div>
						</div>
					</div>`;
			   indexs++;

			   // $('#doc_index_counter').val(indexs);
			   $('#addMoreDocContainer').append(html);
			   $('#doc_index_counter').val(indexs);
...
function load_payrates(){
	$.ajax({
						        type: "POST",
						        url: "{{url('contractor/get_charged_rates')}}",
						        data : {guard_id:'{{ $contractor_id }}', _token : '{{ csrf_token()}}', job_level: $('#job_level').val(), state: $('#payrates_state').val()},
						        success: function(result){
						        if (result.success) {
...
function reload_payrates(id){
	$.ajax({
						        type: "POST",
						        url: "{{url('contractor/reload_charged_rates')}}",
